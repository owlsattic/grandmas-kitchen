...
import { ChefHat, BookOpen, ShoppingBag, Menu, TreePine } from 'lucide-react';
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex gap-6">
                ...
                <Link to="/christmas" className="text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-all duration-300 flex items-center gap-1 group">
                  <TreePine className="h-4 w-4 text-green-600 dark:text-green-500 group-hover:scale-110 transition-transform duration-300" />
                  Christmas
                </Link>
              </nav>
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                ...
                <SheetContent side="left" className="w-64">
                  <nav className="flex flex-col gap-4 mt-8">
                    ...
                    <Link 
                      to="/christmas" 
                      className="text-lg text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-all duration-300 flex items-center gap-2 group"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      <TreePine className="h-5 w-5 text-green-600 dark:text-green-500 group-hover:scale-110 transition-transform duration-300" />
                      Christmas
                    </Link>
                  </nav>
                </SheetContent>
